                  ...
                  <div class="card-body">
					  ...
					  <tbody>
					    ...
					    <tr>
					      ...
					      <td>{{$row->details}}</td>
					      <td>
					      	<a href="{{URL::to('edit/re/'.$row->id)}}" class="btn btn-sm btn-danger">Edit</a>
					      	<a href="{{URL::to('delete/re/'.$row->id)}}" class="btn btn-sm btn-warning">Delete</a>
					      </td>
					    </tr>
					  @endforeach
					  </tbody>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        	<form class="form-horizontal" action="{{route('store-runningelection')}}" method="post">
				        		@csrf
